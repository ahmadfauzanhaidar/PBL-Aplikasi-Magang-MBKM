...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $id = $_POST['id'];
    $nama = $_POST['editNama'];
    $hak_akses = $_POST['editHakAkses'];

    // Query UPDATE
    $sql = "UPDATE tbl_hak SET nama='$nama', hak_akses='$hak_akses' WHERE id=$id";
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow mb-4">
                            ...
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <label for="editHakAkses">Hak Akses:</label>
                                    <select class="form-control" id="editHakAkses" name="editHakAkses">
                                        ...
                                        <option value="superadmin" <?php if ($hak_akses == 'superadmin') echo 'selected'; ?>>Super Admin</option>
                                    </select>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                <!-- ... (Tabel Hak Akses User yang sudah ada) ... -->
                    </div>
                </div>    
            ...
            <!-- Script untuk menyimpan perubahan -->
            <script>
                function simpanPerubahan() {
                    // Mendapatkan data yang diedit dari formulir
                    var editNama = document.getElementById("editNama").value;
                    var editHakAkses = document.getElementById("editHakAkses").value;

                    // Lakukan logika untuk menyimpan perubahan, misalnya:
                    // ...

                    // Setelah perubahan disimpan, bisa memberikan notifikasi atau tindakan lainnya
                    alert("Perubahan disimpan: Nama: " + editNama + ", Hak Akses: " + editHakAkses);
                }
            </script>
